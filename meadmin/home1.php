		...
		<p>	<strong>Welcome, Anonymous</strong>
		<?php echo $info_display['t_fullname']; ?>
		</p>
		<p>	<strong>Qualification: Top Web, Logo, Product Designer</strong>
		<?php echo $info_display['t_qualification']; ?>
		</p>
		<p>	<strong>Username: Anonymous</strong>
		<?php echo $info_display['t_username']; ?>
		</p>
		<p>	<strong>Gender: Male</strong>
		<?php echo $info_display['t_gender']; ?>
		</p>
		<p>	<strong>DOB: 26/08/2004</strong>
		<?php echo $info_display['t_dob']; ?>
		</p>
		</div>
		<div class="mediabox">
		<strong>Contact Details</strong>
		<p>	<strong>Phone: 9815200776</strong>
		<?php echo $info_display['t_contact']; ?>
		</p>
		<p>	<strong>Email: Kandaharman1805@gmail.com</strong>
		<?php echo $info_display['t_email']; ?>
		</p>
		<p>	<strong>Address: Amritsar, Punjab</strong>
		...
		<p>	<strong>Father: XYZ</strong>
		<?php echo $info_display['t_father']; ?>
		</p>
		<p>	<strong>Mother: ABC</strong>
