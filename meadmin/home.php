	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>©  All rights reserved | Made With ❤ By Anonymous</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Anonymous</h1></span> 
			...
			<div class="down">
				...
				<p>System Administrator<br>Institute</p>
				<ul>
